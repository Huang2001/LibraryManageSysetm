...
import cn.edu.ecut.codeutil.IVerifyCodeGen;
import cn.edu.ecut.codeutil.SimpleCharVerifyCodeGenImpl;
import cn.edu.ecut.codeutil.VerifyCode;
import cn.edu.ecut.pojo.Admin;
import cn.edu.ecut.pojo.ReaderInfo;
import cn.edu.ecut.service.AdminService;
import cn.edu.ecut.service.feigninterface.BooksLendService;
...
public class LoginController {
    ...
    @Autowired
    private BooksLendService booksLendService;
    ...
    public String loginIn(HttpServletRequest request, Model model){
        ...
        if (!realCode.toLowerCase().equals(code.toLowerCase())){
            ...
            if(type.equals("1")){//管理员信息
                ...
                ReaderInfo readerInfo=booksLendService.queryUserInfoByNameAndPassword(username,password);
                if(readerInfo==null){
                    model.addAttribute("msg","用户名或密码错误");
                    return "login";
                }
